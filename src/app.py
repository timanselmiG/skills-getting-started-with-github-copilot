...
activities = {
    ...
    "Drama Club": {
        "description": "Learn acting, stage performance, and participate in school plays",
    ...
    "Science Club": {
        "description": "Conduct experiments, explore scientific concepts, and visit science fairs",
